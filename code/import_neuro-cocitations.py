"""
import_neuro-cocitations.py

This script constructs the 'neuro-cocitations' hypergraph directly from
raw OpenAlex data and exports it in the XGI HIF JSON format.

The resulting hypergraph contains:
- Nodes: highly cited Neuroscience papers (top 10% by cumulative
...
# ── Parameters ────────────────────────────────────────────────────────────────
FIELD                   = "Neuroscience"
HYPERGRAPH_NAME         = "neuro-cocitations"
