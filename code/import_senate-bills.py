...
dataset_name = "senate-bills"

new_dataset_name = "senate-bills"

dataset_folder = "senate-bills"
...
node_affiliations_filepath = os.path.join(data_folder, dataset_folder, node_affiliations_file)
affiliation_names_filepath = os.path.join(data_folder, dataset_folder, affiliation_names_file)
...
node_affiliation = utilities.readScHoLPLabels(node_affiliations_filepath, two_column=False)
