...
member_file = "tags-ask-ubuntu-simplices.txt"
n_labels_file = "tags-ask-ubuntu-node-labels.txt"
e_labels_file = "tags-ask-ubuntu-simplex-labels.txt"
times_file = "tags-ask-ubuntu-times.txt"
...
if output_stats:
    ...
    plt.tight_layout()
    plt.savefig("data/tags-ask-ubuntu/stats.png", dpi=300)
    plt.show()
