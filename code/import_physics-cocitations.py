"""
import_physics-cocitations.py

This script constructs the 'physics-cocitations' hypergraph directly from
raw OpenAlex data and exports it in the XGI HIF JSON format.

The resulting hypergraph contains:
- Nodes: highly cited Physics and Astronomy papers (top 10% by cumulative
...
HYPERGRAPH_NAME         = "physics-cocitations"
