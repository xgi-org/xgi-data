"""
import_math-cocitations.py

This script constructs the 'math-cocitations' hypergraph directly from
raw OpenAlex data and exports it in the XGI HIF JSON format.

The resulting hypergraph contains:
- Nodes: highly cited Mathematics papers (top 10% by cumulative
...
# ── Parameters ────────────────────────────────────────────────────────────────
FIELD                   = "Mathematics"
HYPERGRAPH_NAME         = "math-cocitations"
