"""
import_biochem-cocitations.py

This script constructs the 'biochem-cocitations' hypergraph directly from
raw OpenAlex data and exports it in the XGI HIF JSON format.

The resulting hypergraph contains:
- Nodes: highly cited Biochemistry, Genetics and Molecular Biology papers (top 10% by cumulative
...
Raw data files required (place in the same directory as this script):
  - openalex_work_data_Biochemistry, Genetics and Molecular Biology.pickle  (OpenAlex Snapshot 2024-09-27)
  - openalex_topic_data.pickle                  (OpenAlex Snapshot 2024-09-27)

Running this script will reproduce the XGI-compatible JSON file:
  biochem-cocitations.json
"""
...
HYPERGRAPH_NAME         = "biochem-cocitations"
